...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-05-2024 a las 14:50:34
...
(160, 'Producto', 'views/vpro.php', 1, 1, 'fa-solid fa-box-open'),
(261, 'Proveedor', 'views/vprv.php', 1, 1, 'fa-solid fa-user-tie'),
(789, 'Ubicación', 'views/vubi.php', 1, 1, 'fa-solid fa-location-dot');
...
INSERT INTO `pagper` (`idper`, `idpag`) VALUES
(1, 160),
(1, 261),
(1, 789),
(2, 261);
...
CREATE TABLE `persona` (
  `idpsn` bigint(20) NOT NULL,
  `nompsn` varchar(50) DEFAULT NULL,
  `apepsn` varchar(50) DEFAULT NULL,
  `docpsn` varchar(20) DEFAULT NULL,
  `tpdcpsn` int(5) DEFAULT NULL,
  `telpsn` varchar(10) DEFAULT NULL,
  `emapsn` varchar(255) DEFAULT NULL,
  `passpsn` varchar(100) DEFAULT NULL,
  `actpsn` tinyint(1) DEFAULT NULL,
  `idper` int(5) NOT NULL,
  `genpsn` int(5) DEFAULT NULL,
  `fhnapsn` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `pro` (`id`, `nompro`, `despro`, `prcpro`, `imgpro`) VALUES
(1, 'Nintendo Switch', 'Consola eyety etu ru tu tu  trurtu', 1500000, ''),
(2, 'Control Nintendo Switch', 'Accesorio', 350000, NULL),
(3, 'PSPA', '5555', 2255, 'fotis/fot_20240417081214.jpg'),
(4, 'rrr', 'gyiyuiyui', 7777, 'jotos/fot_20240416161929.jpg'),
(5, 'AqS', 'aaauj', 145000, 'fotis/fot_20240417080517.jpg');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `prv`
--

CREATE TABLE `prv` (
  idprv INT(5) NOT NULL,
    nit VARCHAR(12) DEFAULT NULL,
    nomprv VARCHAR(100) DEFAULT NULL,
    razsc VARCHAR(20) DEFAULT NULL,
    dirprv VARCHAR(50) DEFAULT NULL,
    telprv VARCHAR(10) DEFAULT NULL,
    codubi INT(5) DEFAULT NULL,
    corprv VARCHAR(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `ubi` (`codubi`, `nomubi`, `depubi`) VALUES
(5, 'ANTIOQUIA', 0),
(8, 'ATLANTICO', 0),
(11, 'BOGOTÁ D.C.', 0),
(13, 'BOLIVAR', 0),
...
--
ALTER TABLE `pagina`
  MODIFY `idpag` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=790;

--
-- AUTO_INCREMENT de la tabla `perfil`
--
ALTER TABLE `perfil`
  MODIFY `idper` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `persona`
--
ALTER TABLE `persona`
  MODIFY `idpsn` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT de la tabla `prv`
--
ALTER TABLE `prv`
  MODIFY `idprv` int(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ubi`
--
ALTER TABLE `ubi`
  MODIFY `codubi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99776;
...
--
ALTER TABLE `persona`
  ADD CONSTRAINT `persona_ibfk_1` FOREIGN KEY (`idper`) REFERENCES `perfil` (`idper`);
COMMIT;
