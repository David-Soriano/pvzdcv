<nav>
    <ul>
        <li>
            <a href="home.php?pg=160" title="Producto">
        ...
        <li>
            <a href="home.php?pg=261" title="Proveedor">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-truck"
                    viewBox="0 0 16 16">
                    <path
        ...
        <li>
            <a href="home.php?pg=789" title="Ubicación">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-compass"
                    viewBox="0 0 16 16">
                    <path
